...
public class StudentsManager {
    ...
    public static void main(final String[] args) {
        ...
        final StudentEntity student = new StudentEntity(1, null, "John", "Doe", "2022-01-01");
        student.setBrojIndeksa(123456, 2025);

        final StudentEntity.BrojIndeksa brojIndeksa = student.getBrojIndeksa();

        System.out.println(brojIndeksa);
        System.out.println(brojIndeksa.testMethod());

        StudentEntity.DetailsPrinter printer = student.new DetailsPrinter();
